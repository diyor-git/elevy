            ...
            <div className="container-custom">
                ...
                <div className="mb-12 text-center">
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold mb-6">
                        Online-Courses from{' '}
                        <span className="gradient-text">the bests</span>
                    </h1>
                    <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                        Learn from the Yandex, VK, Sber and other top companies
                    </p>
                </div>
                ...
                {/* CTA Section */}
                <div
                    className="mt-20 text-center bg-gradient-to-br from-primary/10 via-secondary/10 to-primary/10 rounded-2xl p-12">
